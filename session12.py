...
'''
T E S T O V A N I   S O F T V E R U  - P Y T E S T
'''
...
print(ping_urllib('https://www.google.com'))
...
print(portscanner("127.0.0.1"))  # 192.168.0.1
...
'''
SBOX ENCRYPTION pre Stream Dat
'''
...
for key in msg:  # Ideme cez BRYNDZA...
    enc_key = sbox_enc(sbox=sbox, key=key)
    print(enc_key)
...
print(najkratsia_cesta(graph, "TT", "KE"))
